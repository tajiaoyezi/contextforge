...
- 发版凭据（post-tag-push backfill，ADR-013）：tag commit `8673bc7` / tag object `v2.0.0-alpha` / release run `28728046534` (success) / ghcr digest `sha256:56e90b4acf5ace13cecb75d329f44867e3bcd74f8950bb968cb86542f5381768` / cosign tlog `2075294365` (sign) · `2075295298` (attest/SBOM) / GitHub Release URL `https://github.com/tajiaoyezi/contextforge/releases/tag/v2.0.0-alpha`。
...
- 发版凭据（post-tag-push backfill，ADR-013）：tag commit `4204550` / tag object `v1.0.2` / release run `28706178209` (success) / ghcr digest `sha256:2a461ea94e73aab99c9a7945e778ded094505b21e7b9cf02c9f5a59f5a61aebe` / cosign tlog `2070346313` (sign) · `2070348819` (attest/SBOM) / GitHub Release URL `https://github.com/tajiaoyezi/contextforge/releases/tag/v1.0.2`。**LICENSE 实测**：`core/Cargo.toml` license 字段 `MIT OR Apache-2.0` 经 `cargo metadata` 验证 SPDX 合法；`LICENSE-MIT` / `LICENSE-APACHE` 全文随 image 发布。
...
- 发版凭据（post-tag-push backfill，ADR-013）：tag commit `94ade88` / tag object `69a6719` / release run `28691648309` (success) / ghcr digest `sha256:dcfbfdac3b8b9f8cab4cfdbb82f1473dad1ca5b0541decc1423869821a071d84` / cosign tlog `2064785505` (sign) · `2064785586` (attest) / GitHub Release URL `https://github.com/tajiaoyezi/contextforge/releases/tag/v1.0.1`。**P0 ldflags 实测成功**：build log 确认 `-ldflags "-X .../cli.Version=v1.0.1"` → 镜像 `contextforge version` 报 `v1.0.1`（D2 缺陷修复验证）。
