...
- [ ] ADR-022 Status Proposed → Accepted 时间 + closeout PR # — **deferred** to follow-up closeout PR (option per user decision: 本 PR 仅 spec Status flip Pending → Done; ADR-022 promotion 单独 closeout PR ship).
