...
| [018](adr-018-fallback-inmem-default-reversal.md) | fallback-inmem-default-reversal | Accepted | v0.7.2 reverses silent in-memory fallback default to 503 (forces opt-in) so degraded state is exposed. Promoted 2026-07-03: D1-D4 already shipped and downstream phases depend on it in force. |
