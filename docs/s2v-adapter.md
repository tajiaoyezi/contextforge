...
|---|---|---|---|---|---|
| 1.1 | proto | docs/specs/tasks/task-1.1-proto.md | Draft | Phase1 #1 | `../ContextForge-wt-foundation` |
...
| 3.1 | importer | docs/specs/tasks/task-3.1-importer-core.md | Draft | Phase3 #1 | `../ContextForge-wt-agent-importers` |
